...
public func Kruskal(lineSegs: [LineSegment], type: SpanningType = .Minimum) -> [LineSegment] {
    ...
    case .Minimum:
        lineSegments.sortInPlace {
            return LineSegment.compareLengths_MAX($0,segment1: $1) < 0
        }
    case .Maximum:
        lineSegments.sortInPlace {
            return LineSegment.compareLengths($0,edge1: $1) < 0
        }
    }
    ...
    for (var i:Int = lineSegments.count - 1; i > -1; i--) {
        ...
        if rootOfSet0 !== rootOfSet1 {
            ...
            // merge the two sets:
            let treeSize0 = rootOfSet0.treeSize
            let treeSize1 = rootOfSet1.treeSize
